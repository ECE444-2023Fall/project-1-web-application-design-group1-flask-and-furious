      ...
      <div className="group relative">
        ...
        <div className="relative rounded-lg bg-purple-100 px-7 py-4">
          <h1 className="scroll-m-20 text-9xl font-extrabold tracking-tighter">
            Club
            <span className="animate-text bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text px-5 py-2 text-transparent">
              Hub
            </span>
          </h1>
          <h3 className="scroll-m-20 text-3xl font-semibold tracking-tight">
            Whats <span className="underline  underline-offset-1">Litty</span>{' '}
            in Your <span className="underline  underline-offset-1">City</span>?
          </h3>
        </div>
      </div>
    </div>
